...
export const STYLES = {
  ...
  // ページレイアウト
  PAGE: {
    MAIN: "min-h-screen flex flex-col items-center justify-center bg-orange-200 p-2 sm:p-4 md:p-8",
    TITLE:
      "text-xl sm:text-2xl md:text-3xl text-neutral-900 font-bold mb-2 sm:mb-4",
    TURN_DISPLAY:
    ...
    HANDS_CONTAINER:
      "flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-8 mb-4 sm:mb-8 w-full max-w-4xl",
    HANDS_ITEM: "flex-1",
    WINNER_MESSAGE:
